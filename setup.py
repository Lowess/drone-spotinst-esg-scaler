...
try:
    ...
    print(
        "drone-spotinst-esg-scaler needs setuptools in order to build. Install it using"
...
static_setup_params = dict(
    name="drone-spotinst-esg-scaler",
    version="0.1",
    description="Adjust the capacity of a Spotinst ESG",
